package net.blueasclepias.bejeweled.data;
...
public class GemDefinitionReloadListener extends SimpleJsonResourceReloadListener {

    public static final Gson GSON = new GsonBuilder().setPrettyPrinting().create();

    public GemDefinitionReloadListener() {
        super(GSON, "gems");
    }
    ...
    protected void apply(Map<ResourceLocation, JsonElement> jsons, ResourceManager manager, ProfilerFiller profiler) {
        ...
        GemDefinitionAccessor.setDefinitions(loaded);
    }
}
